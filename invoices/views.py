                ...
                try:
                    if item.votehead:
                        ...
                        if exists_query.exists():
                            print(f"Stopped and Student is {student} and Fee structure Class is {classes} and student class is {student.classes} and Votehead is {votehead.vote_head_name}")
