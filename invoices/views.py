...
class invoiceView(SchoolIdMixin, generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        for term in terms_list:
            ...
            feeStructureItems = FeeStructureItem.objects.filter(school_id=school_id, fee_Structure__academic_year=academic_year, term=term)
            classes_set = {feeStructureItem.classes for feeStructureItem in feeStructureItems if feeStructureItem.classes is not None}
