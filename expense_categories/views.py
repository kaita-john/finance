...
class ExpenseCategoryCreateView(SchoolIdMixin, DefaultMixin, generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response({'detail': 'ExpenseCategory created successfully'}, status=status.HTTP_201_CREATED)
        else:
...
class ExpenseCategoryDetailView(SchoolIdMixin, DefaultMixin, generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_object(self):
        ...
        try:
            ...
            return ExpenseCategory.objects.get(id=id)
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response({'detail': 'ExpenseCategory updated successfully'}, status=status.HTTP_201_CREATED)
        else:
            return Response({'detail': serializer.errors}, status=status.HTTP_400_BAD_REQUEST)
