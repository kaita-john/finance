...
(function () {
    function u() {
        var c = this.getDialog(), p = c._.editor, n = p.config.linkPhoneRegExp, q = p.config.linkPhoneMsg,
    ...
    CKEDITOR.dialog.add("link", function (c) {
        ...
        var n = CKEDITOR.plugins.link, q,
            t = function () {
                var a = this.getDialog(), b = a.getContentElement("target", "popupFeatures"),
                    a = a.getContentElement("target", "linkTargetName"), r = this.getValue();
            ...
            }, h = c.lang.common, b = c.lang.link, l;
        return {
            title: b.title,
            ...
            contents: [{
                id: "info", label: b.info, title: b.info, elements: [{
                    ...
                    label: b.type,
                    "default": "url",
                    items: [[b.toUrl, "url"], [b.toAnchor, "anchor"], [b.toEmail, "email"], [b.toPhone, "tel"]],
                    onChange: function () {
                        var a = this.getDialog(), b = ["urlOptions", "anchorOptions", "emailOptions", "telOptions"],
                            r = this.getValue(), f = a.definition.getContents("upload"), f = f && f.hidden;
                        ...
                        type: "hbox", widths: ["25%", "75%"], children: [{
                            ...
                            type: "text", id: "url", label: h.url, required: !0, onLoad: function () {
                                ...
                                var a = this.getDialog().getContentElement("info", "protocol"), b = this.getValue(),
                                    c = /^((javascript:)|[#\/\.\?])/i, f = /^(http|https|ftp|news):\/\/(?=.)/i.exec(b);
                ...
                id: "target", requiredContent: "a[target]", label: b.target, title: b.target, elements: [{
                    type: "hbox", widths: ["50%", "50%"], children: [{
                        ...
                        "default": "_blank",
                        style: "width : 100%;",
                        items: [[h.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"], [h.targetNew, "_blank"], [h.targetTop, "_top"], [h.targetSelf, "_self"], [h.targetParent, "_parent"]],
                        onChange: t,
                        setup: function (a) {
                            a.target &&
                            this.setValue(a.target.type || "_blank");
                            t.call(this)
                        },
                        commit: function (a) {
                            a.target || (a.target = {});
            ...
            onShow: function () {
                var a = this.getParentEditor(), b = a.getSelection(), c = this.getContentElement("info",
                    "linkDisplayText").getElement().getParent().getParent(), f = n.getSelectedLink(a, !0),
                    m = f[0] || null;
            ...
            onOk: function () {
                ...
                if (this._.selectedElements.length) {
                    ...
                    for (k = 0; k < b.length; k++) {
                        ...
                        if (m) e = a.linkText; else if (d || l) e = "email" == a.type ? a.email.address : h.set["data-cke-saved-href"];
                        e && g.setText(e);
                        f.push(p(c, g))
                    }
