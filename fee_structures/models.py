...
class FeeStructure(ParentModel):
    ...
    classes = models.ForeignKey(Classes, null=True, default=None, on_delete=DO_NOTHING, related_name="fee_structures")
    term = models.ForeignKey(Term, null=True, default=None, on_delete=DO_NOTHING, related_name="fee_structures")
