...
class FeeStructureItemCreateView(SchoolIdMixin, DefaultMixin, generics.CreateAPIView):
...
class FeeStructureItemListView(SchoolIdMixin, DefaultMixin, generics.ListAPIView):
    serializer_class = FeeStructureItemSerializer
    permission_classes = [IsAuthenticated, IsAdminOrSuperUser]
    ...
    def get_queryset(self):
        ...
        queryset = FeeStructureItem.objects.filter(school_id=school_id)
        return queryset
...
class FeeStructureItemDetailView(SchoolIdMixin, DefaultMixin, generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_object(self):
        ...
        try:
            ...
            return FeeStructureItem.objects.get(id=id)
        except (ValueError, FeeStructureItem.DoesNotExist):
